defmodule BoxingWeb.QuizLive.LlamaMistral do
  ...
  def mount(_params, _session, socket) do
    ...
    %{text_prompt: text_prompt, prompts: prompts} =
      Prompts.get_random_submission_by_fight_type("llama-vs-mistral")
  ...
  def handle_event("start", _, socket) do
    ...
    {:noreply,
     socket
     |> assign(prefight: false)
     |> push_patch(to: ~p"/llama-vs-mistral/question/#{submission_id}")
