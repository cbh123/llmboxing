defmodule BoxingWeb.QuizLive.MixtralGPT do
  ...
  def mount(_params, _session, socket) do
    ...
    %{text_prompt: text_prompt, prompts: prompts} =
      Prompts.get_random_submission_by_fight_type("mixtral-vs-gpt")
  ...
  def handle_event("start", _, socket) do
    ...
    {:noreply,
     socket
     |> assign(prefight: false)
     |> push_patch(to: ~p"/mixtral-vs-gpt-3.5/question/#{submission_id}")
